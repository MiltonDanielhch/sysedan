                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" id="nombre_alcalde"
                                                                    name="nombre_alcalde"
                                                                    placeholder="Nombre Alcalde"
                                                                    class="form-control text" title="Nombre Alcalde" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="number" id="poblacion_total"
                                                                    ...
                                                                    class="form-control text" title="Introducir Nro"
                                                                    required>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-line">
                                                                <input type="date" id="fecha_llenado"
                                                                    name="fecha_llenado" class="form-control text"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                ...
                                                                <select name="tipo_comunidad" id="tipo_comunidad"
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                        ...
                                        <div class="panel-body">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" id="causas_probables"
                                                                    name="causas_probables"
                                                                    placeholder="Introducir Probables"
                                                                    class="form-control text"
                                                                    title="Introducir Probables" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="incendios_activos">Incendios Activos</label>
                                                                <input type="number" id="incendios_activos"
                                                                    name="incendios_activos"
                                                                    placeholder="Introducir Incendios Activos"
                                                                    class="form-control text"
                                                                    title="ntroducir Incendios Activos" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">Incendios en la comunidad</div>
                                                    <div class="panel-body">

                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="incendios_registrados">Incendios
                                                                    Registrados</label>
                                                                <input type="number" id="incendios_registrados"
                                                                    name="incendios_registrados"
                                                                    placeholder="Introducir Incendios Registrados"
                                                                    class="form-control text"
                                                                    title="ntroducir Incendios Registrados" required>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="num_familias_afectadas">Familias
                                                                    Afectadas</label>
                                                                <input type="number" id="num_familias_afectadas"
                                                                    name="num_familias_afectadas"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <label for="num_familias_damnificadas">Familias
                                                                    Damnificadas</label>
                                                                <input type="number" id="num_familias_damnificadas"
                                                                    name="num_familias_damnificadas"
                                                                    placeholder="Introducir Numero"
                                                                    class="form-control text" title="Introducir Nro"
                                                                    required>
                                                            </div>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" name="cantidad_afectados[]"
                                                                            class="form-control">
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                                            ...
                                                            <tbody>
                                                                @foreach ($grupoEtarios as $grupoEtario)
                                                                    <tr>
                                                                        <td>
                                                                            {{ $grupoEtario->nombre_grupo_etario }}
                                                                            <input type="hidden" name="grupo_etario_id[]" value="{{ $grupoEtario->id }}">
                                                                        </td>
                                                                        @foreach ($detalleEnfermedades as $detalleEnfermedad)
                                                                            <td>
                                                                                <input type="hidden" name="detalle_enfermedad_id[]" value="{{ $detalleEnfermedad->id }}">
                                                                                <input type="number" name="cantidad_afectados[]" class="form-control">
                                                                            </td>
                                                                        @endforeach
                                                                        <td>
                                                                            <input type="number" name="total_afectados[]" class="form-control">
                                                                        </td>
                                                                ...
                                                                @foreach ($tiposerviciobasicos as $tiposerviciobasico)
                                                                    <tr>
                                                                        <td>{{ $tiposerviciobasico->nombre_servicio_basico }}
                                                                            <input type="hidden" name="servicio_basico_id[]" value="{{ $tiposerviciobasico->id }}">
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    @foreach ($tipoFaunaEspecies as $tipoFaunaEspecie)
                                                                        <th>{{ $tipoFaunaEspecie->nombre_fauna_especie }}</th>
                                                                    @endforeach
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach ($detalleFaunaSilvestres as $detalleFaunaSilvestre)
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($tipoFaunaEspecies as $tipoFaunaEspecie)
                                                                            <td>
                                                                                <label for="numero_fauna_silvestre_{{ $tipoFaunaEspecie->id }}">{{ $tipoFaunaEspecie->nombre_fauna_especie }}</label>
...
<script>
    ...
    //         if(id_provincia){
    //             $.ajax({
    //                 url:"{{ url('/admin/formularios/create/') }}"+'/'+id_provincia,
    //                 type:"GET",
