                                                                    ...
                                                                    @foreach ($personasAfectadas->groupBy('grupo_etario_id') as $grupoEtarioId => $personaAfectada)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @php
                                                                                    $totalAfectados = 0;
                                                                                    foreach ($personaAfectada as $persona) {
                                                                                        $totalAfectados += $persona->cantidad_afectados_por_incendios;
                                                                                    }
                                                                                @endphp
                                                                            <input type="number" name="total_afectados_{{ $grupoEtarioId }}" value="{{ $totalAfectados }}" class="form-control">
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                                    ...
                                                                    @foreach ($educacions->groupBy('institucion_id') as $institucionId => $educacion)
                                                                        <tr>
                                                                            ...
                                                                            @foreach ($educacion as $edu)
                                                                                <td>
                                                                                    <input type="number" name="num_estudiantes[{{ $institucionId }}][{{ $edu->modalidadEducacion->id }}]" class="form-control" value="{{ $educacionData[$institucionId][$edu->modalidadEducacion->id ] ?? $edu->num_estudiantes }}">
                                                                                </td>
                                                                            @endforeach
                                                                        </tr>
                                                                    @endforeach
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($Salud as $salu)
                                                                            <td>
                                                                                <input type="number" name="cantidad_grupo_enfermos[{{ $grupoEtarioId }}][{{ $salu->detalleEnfermedad->id }}]" class="form-control"
                                                                                value="{{ $saludData[$grupoEtarioId][$salu->detalleEnfermedad->id] ?? $salu->cantidad_grupo_enfermos }}">
                                                                             </td>
                                                                        @endforeach
                                                                    </tr>
                                                                @endforeach
                                                                    ...
                                                                    @foreach ($infraestructuras->groupBy('tipo_infraestructura_id') as $tipoInfraestructuraId => $infraestructura)
                                                                        <tr>
                                                                            ...
                                                                            @foreach ($infraestructura as $infra)
                                                                               <td>
                                                                                <input type="number" name="numeros_infraestructuras_afectadas[{{ $tipoInfraestructuraId }}]" class="form-control" value="{{ $infraestructuraData[$tipoInfraestructuraId] ?? $infra->numeros_infraestructuras_afectadas }}">
                                                                               </td>
                                                                            @endforeach
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>    
                                                                        ...
                                                                        <td>
                                                                            <input type="number" name="numero_animales_fallecidos" class="form-control" value="{{ $SectorPecuario->first()->numero_animales_fallecidos }}">
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
                                                                ...
                                                                <tbody>
                                                                    @foreach ($sectorAgricolas->groupBy('tipo_cultivo_id') as $tipoCultivoId => $sectorAgricola)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="number" name="hectareas_afectados" class="form-control" value="{{ $sectorAgricola->first()->hectareas_afectados }}">
                                                                            </td>
                                                                            <td>
                                                                                <input type="number" name="hectareas_perdidas[]" class="form-control" value="{{ $sectorAgricola->first()->hectareas_perdidas }}">
                                                                            </td>
                                                                    ...
                                                                    @foreach ($faunaSilvestres->groupBy('detalle_fauna_silvestre_id') as $detalleFaunaSilvestreId => $faunaSilvestre)
                                                                        <tr>
                                                                            ...
                                                                            @foreach ($faunaSilvestre as $fauna)
                                                                                <td>
                                                                                    <input type="number" name="numero_fauna_silvestre[{{ $detalleFaunaSilvestreId }}]" class="form-control" value="{{ $faunaSilvestreData[$detalleFaunaSilvestreId][$fauna->tipo_especie_id] ?? $fauna->numero_fauna_silvestre}}">
                                                                                </td>
                                                                            @endforeach
                                                                            {{-- @dump($fauna); --}}
                                                                        </tr>
